...
class CookieController extends Controller
{
    ...
    /**
     * Lists all XssCookie models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new XssCookieSearch();
    ...
    /**
     * Displays a single XssCookie model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing XssCookie model.
    ...
    /**
     * Deletes an existing XssCookie model.
